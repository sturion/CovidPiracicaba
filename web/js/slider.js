...
function changeCss() {
    ...
    let infectadosPrevSlider = document.getElementById("infectadosPrev")
        .innerHTML;
    ...
    if (isolamento == UltRegIsoSlider) {
        ...
        document.getElementById("aviso").style.backgroundColor =
            "rgba(190,0,0,0.85)";
        document.getElementById(
            "aviso"
        ).innerHTML = ` Arraste a barra para simular outros valores`;
    }

    if (infectadosSlider == infectadosPrevSlider) {
        document.getElementById("aviso").style.display = "block";
        document.getElementById("aviso").style.backgroundColor =
            "rgba(20,125,190,0.85)";
        document.getElementById("aviso").innerHTML = `Taxa de Isolamento ideal`;
    }

    let hospitalizadosSlider = document.getElementById("hospitalizados")
        .innerHTML;
    let hospitalizadosPrevSlider = document.getElementById("hospitalizadosPrev")
        .innerHTML;
    ...
    if (demandaLeitos > numeroLietos) {
        ...
        document.getElementById(
            "aviso"
        ).innerHTML = `Possível insuficiência de UTI's em 5 dias`;
    }
}
